...
npy_files = 10
model_path = "/home/leo/ant/super_code/save_restore/model/ant_model"

# Network Parameters
n_hidden_1 = 256 # 1st layer number of neurons
n_hidden_2 = 128 # 2nd layer number of neurons
n_hidden_3 = 128 # 2nd layer number of neurons
num_input = 17*400 #  data input features * No.trees
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        for f_num in range(1,npy_files):

            npy_path = "/home/leo/ant/super_code/save_restore/model/RF_NN_data_{}.npy".format(f_num)
            print("Load -------------------- : RF_NN_data_{}.npy".format(f_num))
    ...
    result = sess.run(tf.argmax(logits, 1), feed_dict={rf_X: test_x})
    print(result)
